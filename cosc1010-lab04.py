# Bradley Ekstrom
# UWYO COSC 1010
# Submission Date: 10/03/74
# Lab 04
# Lab Section: 13
# Sources: Nolan Hottell, Rylie Green
max_temps = [
...
#This adds a variable to each list for later as well as grabbing the length of the list for ease of access.
sum_max = 0
sum_min = 0 
length_list = len(max_temps)


#This loop aquires the sum of each without using the sum function.
for avg in range(length_list):
    sum_max += max_temps[avg]
    sum_min += min_temps[avg]


#These logic functions take the sum and divide it by the list length.
average_max_temp = sum_max / length_list 
average_min_temp = sum_min / length_list


#This prints each out.
print(f"Average maximum temperature, {average_max_temp}")
print(f"Average minimum temperature, {average_min_temp}") 

print("\n Part II")
print("----------------- \n")


#This sorts each list to make it so the value thats lowest and highest can be aquired easily.
max_temps.sort()
min_temps.sort()
print(f"{max_temps[-1]} is the highest temperature recorded.")
print(f"{min_temps[0]} is the lowest temperature recorded.")